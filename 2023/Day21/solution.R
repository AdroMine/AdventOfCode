...
odd_points <- bfs(mat, location, R*2 + 1)
...
even_points <- bfs(mat, location, R*2)
...
corner_points_top <- bfs(mat, c(R, location[2]), R-1)
corner_points_right <- bfs(mat, c(location[1], 1), R-1)
corner_points_left <- bfs(mat, c(location[1], C), R-1)
corner_points_bottom <- bfs(mat, c(1, location[2]), R-1)
